...
class LazyFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $value1 = $this->_lazyFactory->get('key', function () { return 'value'; });
        $value2 = $this->_lazyFactory->get('key', function () { return 'value'; });
        $this->assertSame($value1, $value2);
    }

    public function testCallbackLaziness()
    {
        $value1 = $this->_lazyFactory->get('key', function () { return 'persistent value'; });
        $value2 = $this->_lazyFactory->get('key', function () { return 'nope, this key is already cached'; });
    ...
    {
        $value1 = $this->_lazyFactory->get('key', function () { return 'obedient value'; });
        $this->_lazyFactory->resetCache();
        $value2 = $this->_lazyFactory->get('key', function () { return 'new value'; });
